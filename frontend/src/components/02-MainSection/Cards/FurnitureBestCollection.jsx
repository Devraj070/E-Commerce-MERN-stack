...
function FurnitureBestCollection() {
  const allImages = [img1, img2, img3, img4, img5, img6, img7, img8];
  const sliderRef = useRef(null);

  return (
    <div className="mx-4 px-4 py-4 my-6 bg-gray-300 rounded-lg">
      <div className="flex justify-between items-center mb-2">
        <h2 className="text-2xl font-bold text-gray-800"> On Furnitures</h2>
      </div>
      <div className="overflow-hidden rounded-lg">
        <div ref={sliderRef} className="flex overflow-x-scroll scroll-smooth scrollbar-hide" style={{ scrollBehavior: 'smooth' }}>
...
export default FurnitureBestCollection;
