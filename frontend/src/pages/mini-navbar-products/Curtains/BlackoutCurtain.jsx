...
const BlackoutCurtains = () => {
    const [blackoutCurtains, setBlackoutCurtains] = useState([]);
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                const filteredProducts = response.data.filter(item => item.category === "blackout-curtains")
                setBlackoutCurtains(filteredProducts);
            } catch (error) {
