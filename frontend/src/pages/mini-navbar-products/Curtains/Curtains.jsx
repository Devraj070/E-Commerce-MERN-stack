  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const filteredProducts = response.data.filter(item => item.category === "curtains" || item.category === "sheer-curtains" || item.category === "valances" || item.category === "blackout-curtains")
        setCurtains(filteredProducts);
      } catch (error) {
