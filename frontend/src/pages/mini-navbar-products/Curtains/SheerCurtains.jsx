...
// Products component
const SheerCurtains = () => {
    const [sheerCurtains, setSheerCurtains] = useState([]);
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                const filteredProducts = response.data.filter(item => item.category === "sheer-curtains");
                setSheerCurtains(filteredProducts)
            } catch (error) {
