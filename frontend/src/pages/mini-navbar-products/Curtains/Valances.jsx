...
// Products component
const Valances = () => {
    const [valances, setValances] = useState([]);
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                const filteredProducts = response.data.filter(item => item.category === "valances");
                setValances(filteredProducts);
            } catch (error) {
