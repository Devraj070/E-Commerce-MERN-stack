...
// Products component
const CeilingLights = () => {
    const [ceilingLights, setCeilingLights] = useState([]);
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                const filteredProducts = response.data.filter(item => item.category === "ceiling-lights");
                setCeilingLights(filteredProducts);
            } catch (error) {
