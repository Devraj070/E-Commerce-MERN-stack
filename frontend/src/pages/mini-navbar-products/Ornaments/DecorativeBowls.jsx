...
// Products component
const DecorativeBowls = () => {
    const [decorativeBowls, setDecorativeBowls] = useState([]);
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                const filteredProducts = response.data.filter(item => item.category === "decorative-bowls");
                setDecorativeBowls(filteredProducts)
            } catch (error) {
...
export default DecorativeBowls;
