  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const filteredProducts = response.data.filter(item => item.category === "ornaments" || item.category === "decorative-bowls" || item.category === "figurines" || item.category === "sculptures");
        setOrnaments(filteredProducts)
      } catch (error) {
