...
// Products component
const AbstractArt = () => {
    const [abstractArt, setAbstractArt] = useState([]);
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                const filteredProducts = response.data.filter(item => item.category === "abstract-arts");
                setAbstractArt(filteredProducts)
            } catch (error) {
