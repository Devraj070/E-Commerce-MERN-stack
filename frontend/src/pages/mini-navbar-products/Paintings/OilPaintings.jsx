...
// Products component
const OilPainting = () => {
    const [oilPainting, setOilPainting] = useState([]);
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                const filteredProducts = response.data.filter(item => item.category === "oil-paintings");
                setOilPainting(filteredProducts)
            } catch (error) {
