  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const filteredProducts = response.data.filter(item => item.category === "paintings" || item.category === "canvas-arts" || item.category === "oil-paintings" || item.category === "abstract-arts");
        setPainting(filteredProducts)
      } catch (error) {
