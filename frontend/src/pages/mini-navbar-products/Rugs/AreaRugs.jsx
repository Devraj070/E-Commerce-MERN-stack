...
// Products component
const AreaRugs = () => {
    const [arearugs, setAreaRugs] = useState([]);
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                const filteredProducts = response.data.filter(item => item.category === "area-rugs");
                setAreaRugs(filteredProducts);
            } catch (error) {
