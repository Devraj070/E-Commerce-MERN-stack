...
// Products component
const RoundRugs = () => {
    const [roundRugs, setRoundRugs] = useState([]);
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                const filteredProducts = response.data.filter(item => item.category === "round-rugs");
                setRoundRugs(filteredProducts);
            } catch (error) {
