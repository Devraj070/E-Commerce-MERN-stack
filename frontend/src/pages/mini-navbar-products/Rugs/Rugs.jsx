  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const filteredProducts = response.data.filter(item => item.category === "rugs" || item.category === "area-rugs" || item.category === "runner-rugs" || item.category === "round-rugs");
        setRugs(filteredProducts);
      } catch (error) {
