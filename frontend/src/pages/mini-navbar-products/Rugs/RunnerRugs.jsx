    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                const filteredProducts = response.data.filter(item => item.category === "runner-rugs");
                setRunnerRugs(filteredProducts);
            } catch (error) {
