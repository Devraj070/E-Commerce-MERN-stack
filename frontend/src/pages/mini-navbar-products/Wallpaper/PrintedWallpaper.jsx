...
// Products component
const PrintedWallpaper = () => {
  const [printedWallpaper, setPrintedWallpaper] = useState([]);
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const filteredProducts = response.data.filter(item => item.category === "printed-wallpaper")
        setPrintedWallpaper(filteredProducts);
      } catch (error) {
...
export default PrintedWallpaper;
