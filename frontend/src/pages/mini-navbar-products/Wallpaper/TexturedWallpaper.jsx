...
// Products component
const TexturedWallpaper = () => {
  const [texturedWallpaper, setTexturedWallpaper] = useState([]);
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const filteredProducts = response.data.filter(item => item.category === "textured-wallpaper")
        setTexturedWallpaper(filteredProducts);
      } catch (error) {
...
export default TexturedWallpaper;
