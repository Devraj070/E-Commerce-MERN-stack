  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const filteredProducts = response.data.filter(item => item.category === "wallpaper" || item.category === "patterned-wallpaper" || item.category === "printed-wallpaper" || item.category === "textured-wallpaper")
        setWallpaper(filteredProducts);
      } catch (error) {
